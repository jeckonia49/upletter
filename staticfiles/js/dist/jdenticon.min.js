  ...
  var i = (function (t) {
            ...
            for (
              ...
              if (1 == u.nodeType)
                if (b(u)) t(u);
                  ...
                  for (var f = u.querySelectorAll(y), h = 0; h < f.length; h++)
                    t(f[h]);
            }
    ...
    function k(t, i, e) {
      ...
      function c(e, r, o, u, c) {
        ...
        for (var p = 0; p < c.length; p++)
          (f.A = new A(s + c[p][0] * h, a + c[p][1] * h, h, l++ % 4)),
            r(v, f, h, p);
        t.P();
      }
      var v,
    ...
    function I(t) {
      ...
      for (; r < u.length; o++)
        f[o >> 2] =
          f[o >> 2] |
          (("%" == u[r]
            ? parseInt(u.substring(r + 1, (r += 3)), 16)
            : u.charCodeAt(r++)) <<
            (8 * (3 - (3 & o))));
      ...
      for (r = 0; r < i; r++)
        p += ((g[r >> 3] >>> (4 * (7 - (7 & r)))) & 15).toString(16);
      return p;
    }
    function O(t) {
    ...
    (C.g = function (t, n) {
      ...
      (C.N = function (t, n, i, e, r) {
        this.g(
          [t + i / 2, n, t + i, n + e / 2, t + i / 2, n + e, t, n + e / 2],
          r
        );
      });
    var R = F.prototype;
    ...
    (R.m = function (t) {
      ...
      (R.h = function (t, n, i) {
        var e = this.l,
          r = n / 2;
        e.moveTo(t.x + r, t.y + r),
          e.arc(t.x + r, t.y + r, r, 0, 2 * Math.PI, i),
          e.closePath();
      }),
      (R.finish = function () {
        this.l.restore();
    ...
    function V(t, n) {
      for (var i = [], e = arguments.length - 2; e-- > 0; )
        i[e] = arguments[e + 2];
      for (
        var r = document.createElementNS(G.T, n), o = 0;
        o + 1 < i.length;
        o += 2
      )
